...
# 👋 Привет! Я — **Имя Фамилия** (или @username)
...
- 🤖 **Разрабатываю Telegram-ботов** на Python с интеграцией LLM (Ollama, Anthropic, OpenAI)
...
- Предоставляет цены на услуги, FAQ и послепроцедурные рекомендации из базы знаний
- Интегрирован с Google Calendar для онлайн-записи
- Поддерживает три LLM-провайдера: Ollama (локально), Anthropic Claude, OpenAI
...
![Telegram Bot API](https://img.shields.io/badge/-python--telegram--bot-2CA5E0?style=flat-square&logo=telegram&logoColor=white)
...
> *«Код — это поэзия, которую может прочитать машина, но понять должен человек.»*
